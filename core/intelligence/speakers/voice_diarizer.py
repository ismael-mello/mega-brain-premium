...
def diarize_assemblyai(audio_file: str, num_speakers: int | None = None, language_code: str = "pt") -> list[dict]:
    ...
    try:
        ...
        print(f"[voice_diarizer] AssemblyAI: {detected} speaker(s) detected"
...
def diarize(audio_file: str, num_speakers: int | None = None, language_code: str = "pt") -> list[dict]:
    ...
    if not segments:
        ...
        segments = diarize_assemblyai(audio_file, num_speakers=num_speakers, language_code=language_code)
    return segments
