...
- DNAs: knowledge/external/dna/persons/*/DNA.yaml
...
├──────────────────────────────────────────────────────────────────────────────┤
│   🤖 AGENTES A ALIMENTAR:                                                   │
│      • AGENT-SALES-LEADER.md (gestão de times)                             │
│   📘 PLAYBOOKS IMPACTADOS:                                                  │
│      • PLAYBOOK-CONTRATACAO.md                                             │
│   🧬 DNAs ENRIQUECIDOS:                                                     │
│      • DNA-CG.md (+42 elementos)                                           │
└──────────────────────────────────────────────────────────────────────────────┘
```
</context>
...
2. **Destination extraction** (~100 lines):
   ...
   - Parse ASCII box format with emojis (🤖 AGENTES, 📘 PLAYBOOKS, 🧬 DNAs)
   - Extract agent names from patterns like `• AGENT-SALES-LEADER.md`
   - Extract playbook names from patterns like `• PLAYBOOK-CONTRATACAO.md`
   - Extract DNA names from patterns like `• DNA-CG.md`
...
3. **Path resolution** (~60 lines):
   ...
   - `resolve_dna_path(dna_name: str) -> Optional[Path]`
     Search in: knowledge/external/dna/persons/{name}/DNA.yaml
