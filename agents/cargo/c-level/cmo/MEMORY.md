...
| ID | Situação | Decisão Padrão | chunk_id | PATH_RAIZ | Confiança |
|----|----------|----------------|----------|-----------|-----------|
| PD-CMO-CA-001 | Quanto budget alocar por tipo de criativo? | 60/30/10 (control/data/innovation) | *pendente* | CA-0009-0015 | alta |
| PD-CMO-CA-002 | Thumbnail não converte? | Flash Test 1s + Mobile Preview + A/B | *pendente* | CA-0016 | alta |
| PD-CMO-CA-003 | Como criar hook do thumbnail? | 5 Curiosity Gap Archetypes (B/A, Challenge, Contradiction, Novelty, Result) | *pendente* | CA-0016 | alta |
